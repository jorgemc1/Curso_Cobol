      ...
      *    VARIÁVEIS TRUNCADAS.
       ...
       PROGRAM-BEGIN.
           ...
           DISPLAY "VALORES TRUNCADOS".
           DISPLAY "".

           MOVE "Jorge" TO 6-BYTES.
           MOVE "Jorge" TO 5-BYTES.
           MOVE "Jorge" TO 4-BYTES.
           MOVE "Jorge" TO 3-BYTES.
           MOVE "Jorge" TO 2-BYTES.
           MOVE "Jorge" TO 1-BYTE.
